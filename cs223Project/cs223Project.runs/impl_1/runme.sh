...
HD_PWD='C:/Users/umityigitbsrn/Desktop/cs223Project/cs223Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gameMain.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gameMain.tcl -notrace
