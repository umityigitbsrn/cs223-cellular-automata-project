...
HD_PWD='C:/Users/umityigitbsrn/Desktop/cs223Project/cs223Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gameMain.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gameMain.tcl
