...
set_property PACKAGE_PIN W14 [get_ports {modeSelect[0]}] 	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {modeSelect[0]}] 
set_property PACKAGE_PIN W13 [get_ports {modeSelect[1]}] 	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {modeSelect[1]}] 
...
#set_property PACKAGE_PIN R3 [get_ports {b1}] 	 	 	 	 	 
# 	set_property IOSTANDARD LVCMOS33 [get_ports {b1}] 
#set_property PACKAGE_PIN W2 [get_ports {b2}] 	 	 	 	 	 
